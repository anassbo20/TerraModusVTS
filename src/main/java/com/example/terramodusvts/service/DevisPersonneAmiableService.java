package com.example.terramodusvts.service;
...
import com.example.terramodusvts.repositories.DemandeurPersonneRepository;
import com.example.terramodusvts.repositories.ImmobRepository;
import com.example.terramodusvts.repositories.TypeDevisRepository;
import com.example.terramodusvts.repositories.devisPersonne.DevisPersonneAmiableRepository;
...
public class DevisPersonneAmiableService {
    ...
    public DevisPersonneAmiable saveDevise(DevisPersonneAmiable devise) throws MessagingException, jakarta.mail.MessagingException, JRException, IOException, ParseException, XmlException {
        ...
        switch (devise.getImmobs().get(0).getTypeBien()) {
            ...
            case Bureau,Lot_Terr,Comm ->  PEI = df.format(q*2500.00).replace(',', ' ');
        ...
        emailService.sendHtmlMessage("salahelkacimi@gmail.com", "Demande Devis", byteArray, file);
        return savedDevis;
        }
